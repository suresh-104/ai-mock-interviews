...
export default function ThemeToggle() {
  ...
  const switchOnRef = useRef<HTMLAudioElement | null>(null);
  const switchOffRef = useRef<HTMLAudioElement | null>(null);
  ...
  if (!mounted)
    ...
    ); // Évite de rendre avant le montage du composant
  ...
  return (
    <div>
      ...
      <audio ref={switchOnRef} src="/sounds/switch-on.mp3" />
      <audio ref={switchOffRef} src="/sounds/switch-off.mp3" />
    </div>
  );
}
